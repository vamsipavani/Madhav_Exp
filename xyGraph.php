...
$text_color = imagecolorallocate($image, 10, 50, 10);

$grey = ImageColorAllocate($image, 34, 139, 34);
$white = imagecolorallocate($image, 34, 139, 34);
...
for($i = 0; $i < $graph_n; $i++ )
 ...
 //  imagesetpixel( $image, $pt_x, $pt_y, $black );
   imagechar($image, 2, $pt_x - 3, $pt_y - 10, '.', $red);
   }
